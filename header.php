        ...
        <div class="container">
            <div class="row">
                <div class="hidden-xs col-lg-7 col-sm-5 top-info">
                    <?php
                        if( $phone ){
                            printf( '<span><i class="fa fa-phone"></i>Phone: <a href="tel:+%3$s%4$s" style="color: white">+%1$s %2$s</a></span>', $cc, substr_replace( $phone, '-', 5, 0), $cc, $phone );
                        }else{
                            admin_note( 'Your Phone Number', 'theme-settings', '.contact_number' );
                        }
                        if( $email ){
                            printf( '<span class="hidden-sm"><i class="fa fa-envelope"></i>Email: <a href="mailto:%1$s" style="color: white">%2$s</span>', $email, $email );
                        }else{
